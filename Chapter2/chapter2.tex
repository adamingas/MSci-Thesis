...
The class distribution defines a Bernoulli likelihood with success probability $P(y_i = 1| \mathbf{x}_i, \bm{\theta})$ being modelled as a function of the features
\begin{align}
